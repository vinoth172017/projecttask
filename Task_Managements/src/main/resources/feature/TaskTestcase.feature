...
@TC_01_Login
Scenario Outline:Login into Task_Mangement Website
...
@TC_02_Add_Task
Scenario: Add Task in Task_Mangement Website
...
@TC_03_Search_Task
Scenario: Searching in Task_Mangement Website
...
Scenario: Printing Task Table in Task_Mangement Website
